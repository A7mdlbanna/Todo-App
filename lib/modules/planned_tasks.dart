  ...
  Widget build(BuildContext context) {
    return  BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state){
        var tasks = AppCubit.get(context).plannedTasks;
        ...
        builder: (context, state) {
          ...
          child: Padding(
            ...
            child: Row(children: [
              IconButton(
                onPressed: () {
                  cubit.updateData(status: 'planned', id: task['id']);
                },
                icon: cubit.isDone
                    ? Icon(
                  Icons.check_circle,
              ...
              Expanded(
                child: Container(
                  ...
                  child: IconButton(
                    onPressed: () {
                      cubit.updateData(status: 'Important', id: task['id']);
                      // cubit.changeIsImportantState();
                    },
                    icon: cubit.isImportant
                        ? Icon(
                      Icons.star,
                      size: 35,
